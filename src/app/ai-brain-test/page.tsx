            ...
            <div className="mx-auto max-w-6xl space-y-6 p-6">
						...
						<Card className="border-purple-200 border-dashed bg-purple-50/50 shadow-soft">
							<CardHeader className="pb-3">
								...
								<CardDescription className="text-purple-700">
									Full pipeline: Document Ingestion (Gemini) → Rule Evaluation → Final Report (Claude)
								</CardDescription>
							</CardHeader>
							<CardContent className="space-y-3">
								{!demoGlId ? (
				...
				<div className="rounded-xl border border-gray-200 bg-gray-50/50 p-4 text-center text-gray-500 text-xs">
					<p>
						...
						<strong>Gemini</strong> handles document parsing and clause extraction.{" "}
						<strong>Claude</strong> generates rule-adherent risk assessments.
					</p>
				</div>
            </div>
        </div>
